...
if __name__ == '__main__':
    ...
    for epoch in tqdm(range(start_epoch, start_epoch + args.epochs)):
        ...
        curr_tau = tau_start - (tau_start - tau_end) * epoch / args.epochs
        temperature_list = [curr_tau]
        ...
        curr_loss = nf_drift_loss_model(x_gen, pos_samples, nf_score, temperature_list=temperature_list)   # (B, )
        ...
        if (epoch + 1) % args.sample_freq == 0 or draw_flag:
            model.eval()
