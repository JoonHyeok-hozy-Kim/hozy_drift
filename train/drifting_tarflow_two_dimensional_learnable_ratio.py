...
from models.drift_loss import NFDriftLossFunction_LearnableRatio
...
if __name__ == '__main__':
    ...
    parser.add_argument('--init_vp_vq_ratio', default=1.0, type=float, help='Ratio V_p/V_q')
    ...
    settings_str = ""
    settings_str += f"init_vp_vq_ratio_{args.init_vp_vq_ratio}"
    ...
    nf_drift_loss_model = NFDriftLossFunction_LearnableRatio(init_vp_vq_ratio=args.init_vp_vq_ratio)
